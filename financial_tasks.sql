IF NOT EXISTS (SELECT * FROM sys.databases WHERE name = 'FinancialEngineering')
BEGIN
    CREATE DATABASE FinancialEngineering;
END
GO

USE FinancialEngineering;
GO
...
SELECT * FROM dbo.financial_tasks;